...
public class GameAssetsManager : UnitySingleton<GameAssetsManager>
{
    ...
    /// 現金房間按鈕
    /// </summary>
    public GameObject CashRoomBtnObj { get; set; }
    ...
    public IEnumerator ILoadAssets()
    {
        ...
        //玩家訊息物件
        request = Resources.LoadAsync<GameObject>("ObjType/Game/GamePlayerInfo");
        yield return request;
        GamePlayerInfoObj = request.asset as GameObject;

        //獲勝籌碼物件
        request = Resources.LoadAsync<GameObject>("ObjType/Game/WinChips");
        yield return request;
        WinChipsObj = request.asset as GameObject;

        //現金房間按鈕
        request = Resources.LoadAsync<GameObject>("ObjType/Lobby/CashRoomBtn");
        yield return request;
        CashRoomBtnObj = request.asset as GameObject;
    }
